...
export default function Login() {
    return (
        <div className="w-1/3">
            <h1 className="text-[#e0e0e0] tracking-wider font-heading text-5xl ml-2">Login</h1>
            <div className="flex flex-col mt-6">
                ...
                <div className="border-2 mt-4 border-black rounded-lg">
                ...
                <Button variant="secondary" className="mt-5 text-xl tracking-tight font-bold">
                    Login
                </Button>
            </div>
        </div>
